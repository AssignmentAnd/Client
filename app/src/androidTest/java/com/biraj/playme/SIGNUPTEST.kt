...
class SIGNUPTEST {
    ...
    fun sIGNUPTEST() {
        ...
        Thread.sleep(5000)
        appCompatEditText3.perform(replaceText("biraj"), closeSoftKeyboard())
        ...
        Thread.sleep(5000)
        appCompatEditText4.perform(replaceText("biraj"), closeSoftKeyboard())
        ...
        Thread.sleep(5000)
        appCompatEditText5.perform(replaceText("biraj"), closeSoftKeyboard())
